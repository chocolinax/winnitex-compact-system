...
Route::get('/user_profile/get/{id}', function ($id) {
    $info = DB::table('record_lists')
        ->select('brands.brand', 'types.type', 'assets.model_no', 'assets.serial_no', 'locations.location', 'record_lists.stocktake_date')
        ...
        ->groupBy('brands.brand', 'types.type', 'assets.model_no', 'assets.serial_no', 'locations.location', 'record_lists.stocktake_date')
        ->get();
    return $info;
});
